...
namespace Datos
{
    public static class Configuracion
    {
        ...
        public const string RUTA_CATEGORIAS = "Categorias.txt";
        public const string RUTA_DETALLES_FACTURAS = "DetallesFacturas.txt";
        public const string RUTA_FACTURAS = "Facturas.txt";
        public const string RUTA_DETALLES_ELECTRONICOS = "DetallesElectronicos.txt";
    }
}
